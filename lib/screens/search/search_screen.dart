      ...
      appBar: AppBar(
        title: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: GoogleFonts.nunito(color: AppTheme.textHint, fontSize: 16),
          ),
                        ...
                        children: [
                          ...
                          ...kAllGenres.map((g) => Padding(
                            ...
                            child: _FilterChip(
                              ...
                              onTap: () {
                                setState(() => _selectedGenre = _selectedGenre == g ? '' : g);
                    ...
                    Row(
                      children: [
                        ...
                        _StatusChip(
                          ...
                          onTap: () {
                            setState(() => _selectedStatus = _selectedStatus == 'ongoing' ? '' : 'ongoing');
                        ...
                        _StatusChip(
                          ...
                          onTap: () {
                            setState(() => _selectedStatus = _selectedStatus == 'completed' ? '' : 'completed');
                            provider.filterByStatus(_selectedStatus);
                          },
                        ),
                        const SizedBox(width: 8),
                        _StatusChip(
                          ...
                          onTap: () {
                            setState(() => _selectedStatus = _selectedStatus == 'hiatus' ? '' : 'hiatus');
                            provider.filterByStatus(_selectedStatus);
                          },
                        ),
                      ],
                    ...
                    : provider.novels.isEmpty
                        ? Center(
                            child: Column(
                              ...
                              children: [
                                const Icon(Icons.search_off_rounded, size: 56, color: AppTheme.textHint),
